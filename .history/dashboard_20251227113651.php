...
<div class="card mb-3">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <!-- ================= SUMATERA ================= -->
            <div class="col-md-4 mb-3">
                <label class="form-label">Instalasi Sumatera (Sebelum Diskon)</label>
                <div class="input-group">
                    <span class="input-group-text">Rp</span>
                    <input type="number" class="form-control" id="instalasi_sumatera_before" placeholder="Harga normal">
                </div>
            </div>

            <div class="col-md-4 mb-3">
                <label class="form-label">Instalasi Sumatera (Sesudah Diskon)</label>
                <div class="input-group">
                    <span class="input-group-text">Rp</span>
                    <input type="number" class="form-control" id="instalasi_sumatera" placeholder="Harga promo">
                </div>
            </div>

            <!-- ================= JAWA ================= -->
            <div class="col-md-4 mb-3">
                <label class="form-label">Instalasi Jawa (Sebelum Diskon)</label>
                <div class="input-group">
                    <span class="input-group-text">Rp</span>
            ...
            <div class="col-md-4 mb-3">
                <label class="form-label">Instalasi Jawa (Sesudah Diskon)</label>
                <div class="input-group">
                    <span class="input-group-text">Rp</span>
            ...
            <!-- ================= TIMUR ================= -->
            <div class="col-md-4 mb-3">
                <label class="form-label">Instalasi Timur (Sebelum Diskon)</label>
                <div class="input-group">
                    <span class="input-group-text">Rp</span>
            ...
            <div class="col-md-4 mb-3">
                <label class="form-label">Instalasi Timur (Sesudah Diskon)</label>
                <div class="input-group">
                    <span class="input-group-text">Rp</span>
