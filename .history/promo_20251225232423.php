                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center">
                        ...
                        onclick="pesanSekarang({
                            nama: 'hebat 6',
                            deskripsi: 'ini hebat 6',
                            region: 'ALL',
                            diskon: '0.00%',
                            periode: '9 Des 2025 - 31 Jan 2026'
                        })">
                        Pesan Sekarang →
                        </button>
                        <button class="btn btn-order btn-sm"
                        onclick="pesanSekarang({
                            nama: 'Promo Akhir Tahun Jawa & Bali',
                            deskripsi: 'Diskon hingga 30% untuk semua paket',
                            region: 'Jawa & Bali',
                            diskon: '30.00%',
                            periode: '1 Des 2025 - 31 Des 2025'
                        })">
                        Pesan Sekarang →
                        </button>
