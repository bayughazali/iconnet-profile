...
function hargaView(before, after) {
...
function renderHarga(lokasi) {
  document.querySelectorAll('.package-price').forEach(el => {
    ...
    if (lokasi === 'sumatera-kalimantan') {
      before = el.dataset.sumateraBefore;
      after  = el.dataset.sumatera;
    } 
    else if (lokasi === 'jawa-bali') {
      before = el.dataset.jawaBefore;
      after  = el.dataset.jawa;
    } 
    else if (lokasi === 'indonesia-timur') {
      before = el.dataset.timurBefore;
      after  = el.dataset.timur;
    }
...
document.querySelectorAll('.location-item').forEach(item => {
  item.addEventListener('click', () => {
    ...
    renderHarga(item.dataset.location);
  });
});
</script>
