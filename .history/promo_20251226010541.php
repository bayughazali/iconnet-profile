        ...
        <div class="modal-content rounded-4">
            ...
            <div class="modal-body">
                ...
                <ul class="list-unstyled">
                    <li><strong>Region:</strong> <span id="promoDetailRegion"></span></li>
                    <li><strong>Diskon:</strong> <span id="promoDetailDiscount"></span></li>
                    <li><strong>Periode:</strong> <span id="promoDetailPeriod"></span></li>
                </ul>
            </div>
...
async function showPromoDetail(promoId) {
    try {
        ...
        if (result.success) {
            ...
            document.getElementById('promoDetailDiscount').innerText =
...
async function orderPromo(promoId) {
    try {
        ...
        if (result.success) {
            ...
            // Contoh aksi saat klik "Pesan Sekarang"
            // 👉 Bisa diarahkan ke WhatsApp / halaman order / checkout
...
Region: ${promo.region.toUpperCase()}
        ...
        console.error('Error ordering promo:', error);
        alert('Gagal memproses pesanan promo.');
    }
}
