...
if ($method === 'POST') {
    ...
    $sumatera_before = toInt($_POST['sumatera_before'] ?? 0);
    $jawa_before     = toInt($_POST['jawa_before'] ?? 0);
    $timur_before    = toInt($_POST['timur_before'] ?? 0);

    $instalasi_sumatera_before = toInt($_POST['instalasi_sumatera_before'] ?? 0);
    $instalasi_jawa_before     = toInt($_POST['instalasi_jawa_before'] ?? 0);
    $instalasi_timur_before    = toInt($_POST['instalasi_timur_before'] ?? 0);
