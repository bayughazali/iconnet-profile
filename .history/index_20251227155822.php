...
document.querySelectorAll('.btn-pilih').forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    const kecepatan = btn.dataset.kecepatan;
    ...
    btnWhatsapp.dataset.text = 
      `Halo, saya ingin pesan paket ${nama} (${kecepatan}) dengan harga Rp ${Number(harga).toLocaleString('id-ID')}`;
...
btnWhatsapp.onclick = () => {
  const nomorWA = '6281234567890'; // GANTI NOMOR WA
