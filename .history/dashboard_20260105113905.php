            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editSliderForm">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Nama Slider</label>
                            <input type="text" class="form-control" id="edit-slider-name" name="" required>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="file"
                                ...
                                accept="image/png,image/jpeg,image/jpg" name="id">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Status</label>
                          <select id="edit-slider-status" name="is_active" class="form-select">
                                <option value="1">Aktif</option>
                                <option value="0">Nonaktif</option>
                            </select>
                        </div>
