            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addSliderForm">
                        ...
                        <div class="mb-3">
                            <label class="form-label"><i class="fas fa-image me-2 text-primary"></i>Path Gambar</label>
                            <input type="text" class="form-control" id="add-slider-image" placeholder="image/slide4.png" required>
                            <small class="text-muted">Format: image/namafile.png</small>
                        </div>
                        <div class="mb-3">
