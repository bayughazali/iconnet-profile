    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-gradient-primary text-white">
                <h5 class="modal-title"><i class="fas fa-plus-circle me-2"></i>Tambah Promo Baru</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <form id="addPromoForm">
                    <div class="mb-3">
                        <label class="form-label"><i class="fas fa-tag me-2 text-primary"></i>Judul Promo</label>
                        <input type="text" class="form-control" id="add-promo-title" placeholder="Contoh: Promo Akhir Tahun Jawa & Bali" required>
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label"><i class="fas fa-align-left me-2 text-primary"></i>Deskripsi</label>
                        <textarea class="form-control" id="add-promo-description" rows="3" placeholder="Deskripsi promo..." required></textarea>
                    </div>
                    
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="fas fa-map-marker-alt me-2 text-primary"></i>Region</label>
                            <select class="form-select" id="add-promo-region" required>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="fas fa-percent me-2 text-primary"></i>Diskon (%)</label>
                            <input type="number" class="form-control" id="add-promo-discount" placeholder="30" min="0" max="100" step="0.01">
                            <small class="text-muted">Opsional, kosongkan jika tidak ada diskon persentase</small>
                        </div>
                    </div>
                    
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="fas fa-calendar-check me-2 text-primary"></i>Tanggal Mulai</label>
                            <input type="date" class="form-control" id="add-promo-start" required>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="fas fa-calendar-times me-2 text-primary"></i>Tanggal Berakhir</label>
                            <input type="date" class="form-control" id="add-promo-end" required>
                        </div>
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label"><i class="fas fa-image me-2 text-primary"></i>Upload Gambar Promo (Opsional)</label>
                        <div class="upload-area" id="add-promo-upload-area">
                            ...
                            <input type="file" id="add-promo-image-file" accept="image/*" style="display: none;">
                        </div>
                        <div id="promo-image-preview" class="mt-3" style="display: none;">
                            <div class="preview-container">
                                <img id="promo-preview-img" src="" alt="Preview" class="img-thumbnail">
                                <button type="button" class="btn btn-sm btn-danger remove-image" onclick="removePromoImage()">
                                    <i class="fas fa-times"></i> Hapus
                                </button>
                            </div>
                            <p class="text-muted small mt-2" id="promo-file-name"></p>
                        </div>
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label"><i class="fas fa-toggle-on me-2 text-primary"></i>Status</label>
                        <select class="form-select" id="add-promo-status">
                            <option value="true">✓ Aktif (Tampil di Halaman Promo)</option>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="addPromo()">Simpan Promo</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="editPromoModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                <button type="button" class="btn btn-warning" onclick="savePromo()">Simpan Perubahan</button>
            </div>
        </div>
    </div>
</div>
...
function previewSliderImage(input) {
    const img = document.getElementById('preview-slider-image');
...
function addSlider() {
    ...
    formData.append('image', document.getElementById('add-slider-image').files[0]);
    formData.append('is_active', document.getElementById('add-slider-status').value);
