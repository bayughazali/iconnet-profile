...
function renderHarga(lokasi) {
  document.querySelectorAll('.package-price').forEach(priceEl => {
    ...
    if (lokasi === 'sumatera-kalimantan') {
      before = priceEl.dataset.sumateraBefore;
      after  = priceEl.dataset.sumatera;
    } 
    else if (lokasi === 'jawa-bali') {
      before = priceEl.dataset.jawaBefore;
      after  = priceEl.dataset.jawa;
    } 
    else if (lokasi === 'indonesia-timur') {
      before = priceEl.dataset.timurBefore;
      after  = priceEl.dataset.timur;
    }
